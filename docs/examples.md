...
- `TestHandlerAddsHeadersToSimpleResponse`
- `TestHandlerAnswersPreflight`
- `TestHandlerKeepsResponseOrderForMixedOrigins`
- `TestHandlerShortCircuitsForbiddenOrigin`
- `TestNewHandlerRejectsMissingOrigins`
